...
#Source1: http://www.garloff.de/kurt/linux/%%{rescan_script}-%%{rescan_version} # not available any more
Source1: %{rescan_script}-%{rescan_version}
Patch1: sg3_utils-1.28-dont-open-dev-snapshot.patch
...
* Thu Feb 26 2015 David Sommerseth <davids@redhat.com> - 1.28-7
- backported sg_xcopy and sg_copy_results (#1051363)

* Tue Jun 24 2014 Dan Horák <dhorak@redhat.com> - 1.28-6
- update rescan-scsi-bus.sh to 1.57 (#857200)
- Resolves: #857200

* Thu May 30 2013 Dan Horák <dhorak@redhat.com> - 1.28-5
- sginfo should not open /dev/snapshot (#920687)
- Resolves: #920687

* Mon Jul 04 2011 Dan Horák <dhorak@redhat.com> - 1.28-4
- issue scan command also for iSCSI - #628553
- Resolves: #628553

* Mon Jun 28 2010 Dan Horák <dan@danny.cz> - 1.28-3
- fix for scanning first LUN mentioned in comment 11 of #538787
- Related: #538787
...
* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 1.28-1.1
- Rebuilt for RHEL 6
